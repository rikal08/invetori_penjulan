...
$html .='<h4 id="title">Laporan Transaksi Masuk <br> Toko Putra Jaya</h4>';
...
$no=1;
$total=0;
$t_masuk = mysqli_query($con,"SELECT * FROM tb_transaksi_masuk WHERE date(tanggal) BETWEEN '$_POST[tgl_awal]' AND '$_POST[tgl_akhir]' ORDER BY id DESC");
...
$html .='<tr>
<th colspan="6" style="text-align: right;">Total Barang Terjual</th>
<th>'. $total .'</th>
</tr>';
...
$dompdf->render();
$dompdf->stream('laporan-transaksi-masuk.php');
?>